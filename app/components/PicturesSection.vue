    ...
    <div id="pics" class="w-full bg-secondary py-20">
        ...
        <div class="flex gap-0 overflow-x-auto no-scrollbar pl-page py-4 scroll-smooth">
            <div v-for="(picture, index) in pictures" :key="index" class="flex flex-col gap-3 shrink-0 w-[700px]">
                ...
                <!-- picture frame -->
                <div class="aspect-[4/3] mx-4 overflow-hidden">
            ...
            <NuxtLink to="/pics" class="flex flex-col gap-3 shrink-0 group cursor-pointer">
                ...
                <!-- picture frame -->
                <div
                    class="h-[501px] w-96 border-[1.5px] border-[#353535] mx-4 flex flex-col items-center justify-center gap-2 text-secondary group-hover:border-solid group-hover:bg-[#e8e8e8] transition-all">
                    <p class="text-2xl">View Full Gallery</p>
